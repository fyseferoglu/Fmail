		...
		<div class="row content">
			<div class="col-sm-3 sidenav">
				...
				<ul class="nav nav-pills nav-stacked">
					...
					<li class="active"><a href="sentmail.jsp"><span class="glyphicon glyphicon-share"></span> Sent Mail </a></li>
			...
			<div class="col-sm-9">
				...
				%>
				<%  					
					List<Mail> list=MailDao.getAllSentMail((String)session.getAttribute("user"));						
					request.setAttribute("allMails",list);
				...
				<table class="table table-condensed">
					<thead>
					    ...
					    <tbody>
					    	...
					    	<c:forEach items="${allMails}" var="m" >					    		
					    		<tr class='clickable-row' data-href='mail.jsp?id=${m.mailid}'>
					    			<td><c:out value="${m.receiver}"></c:out></td>
